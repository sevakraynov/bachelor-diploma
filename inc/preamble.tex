...
\hypersetup{
    ...
    pdfauthor={Крайнов Всеволод, 2019 ©},
    pdftitle={Тестирование метода расщепления третьего порядка для 2D уравнений динамики}
}
...
\titleformat{\section}{\bfseries}{}{12.5mm}{{\thesection\quad\MakeTextUppercase{#1}}}
\titleformat{\subsection}[block]{\bfseries}{}{12.5mm}{\thesubsection\quad#1\vspace{1em}}
